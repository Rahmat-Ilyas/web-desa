...
$get = $data->where('kategori', 'sejarah')->first();
@endphp
            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Sejarah Desa</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                ...
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Sejarah Desa</h4>
                        </div>
                        <hr class="mb-0">
