                    ...
                    <div class="p-b-20">
                        ...
                        <div class="flex-s-s">
                            ...
                            <div class="flex-wr-s-s size-w-0">
                                <a href="https://api.whatsapp.com/send?text={{ 'File Download - Desa Rante Angin ' . url()->current() }}"
                                    target="_blank"
                                ...
                                <a href="https://twitter.com/intent/tweet?text={{ 'File Download - Desa Rante Angin ' . url()->current() }}"
                                    target="_blank"
...
@section('javascript')
    <script>
        ...
        $(document).find('title').text('File Download - Desa Rante Angin')
    </script>
@endsection
